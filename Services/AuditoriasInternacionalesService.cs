...
{
    public class AuditoriasInternacionalesService : IAuditoriasInternacionalesService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public AuditoriasInternacionalesService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<AuditoriasInternacionales>> ListarTodo()
        {
            try { return await _replica.AuditoriasInternacionales.ToListAsync(); }
        ...
        {
            try { return await _replica.AuditoriasInternacionales.FindAsync(id); }
        ...
        public async Task<bool> Insertar(AuditoriasInternacionales m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar AuditoriasInternacionales: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, AuditoriasInternacionales m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar AuditoriasInternacionales: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_auditorias_internacionales.delete_auditoria(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar AuditoriasInternacionales: {ex.Message}"); throw; }
        }
    }
}
