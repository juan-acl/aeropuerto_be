...
namespace Aeropuerto.Backend.Services
{
    public class CargaCombustibleService : ICargaCombustibleService
    {
        ...
        public CargaCombustibleService(DBContext context) => _context = context;

        public async Task<List<CargasCombustible>> ListarTodo()
        {
            try { return await _context.CargasCombustible.ToListAsync(); }
        ...
        {
            try { return await _context.CargasCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(CargasCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar CargasCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, CargasCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar CargasCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_cargas_combustible.delete_carga(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar CargasCombustible: {ex.Message}"); return false; }
        }
    }
}
