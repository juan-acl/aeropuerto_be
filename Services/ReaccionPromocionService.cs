...
namespace Aeropuerto.Backend.Services
{
    public class ReaccionPromocionService : IReaccionPromocionService
    {
        ...
        {
            try { return await _context.ReaccionesPromociones.ToListAsync(); }
        ...
        {
            try { return await _context.ReaccionesPromociones.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ReaccionesPromociones m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ReaccionesPromociones: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, ReaccionesPromociones m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ReaccionesPromociones: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_reacciones_promociones.delete_reaccion(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ReaccionesPromociones: {ex.Message}"); return false; }
        }
    }
}
