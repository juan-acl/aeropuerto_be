...
namespace Aeropuerto.Backend.Services
{
    public class FacturacionCombustibleService : IFacturacionCombustibleService
    {
        ...
        public FacturacionCombustibleService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<FacturacionCombustible>> ListarTodo()
        {
            try { return await _replica.FacturacionCombustible.ToListAsync(); }
        ...
        {
            try { return await _replica.FacturacionCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(FacturacionCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar FacturacionCombustible: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, FacturacionCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar FacturacionCombustible: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_facturacion_combustible.delete_factura(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar FacturacionCombustible: {ex.Message}"); throw; }
        }
    }
}
