...
{
    public class AsignacionServicioService : IAsignacionServicioService
    {
        ...
        {
            try { return await _context.AsignacionesServiciosTransporte.ToListAsync(); }
        ...
        {
            try { return await _context.AsignacionesServiciosTransporte.FindAsync(id); }
        ...
        public async Task<bool> Insertar(AsignacionServiciosTransporte m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar AsignacionServiciosTransporte: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, AsignacionServiciosTransporte m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar AsignacionServiciosTransporte: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_asignacion_servicios.delete_asignacion(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar AsignacionServiciosTransporte: {ex.Message}"); return false; }
        }
    }
}
