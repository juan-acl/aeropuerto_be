...
namespace Aeropuerto.Backend.Services
{
    public class EncuestaPostVueloService : IEncuestaPostVueloService
    {
        ...
        {
            try { return await _context.EncuestasPostVuelo.ToListAsync(); }
        ...
        {
            try { return await _context.EncuestasPostVuelo.FindAsync(id); }
        ...
        public async Task<bool> Insertar(EncuestasPostVuelo m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar EncuestasPostVuelo: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, EncuestasPostVuelo m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar EncuestasPostVuelo: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_encuestas_post_vuelo.delete_encuesta(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar EncuestasPostVuelo: {ex.Message}"); return false; }
        }
    }
}
