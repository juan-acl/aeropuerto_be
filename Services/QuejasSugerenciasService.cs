...
namespace Aeropuerto.Backend.Services
{
    public class QuejasSugerenciasService : IQuejasSugerenciasService
    {
        ...
        {
            try { return await _context.QuejasSugerencias.ToListAsync(); }
        ...
        {
            try { return await _context.QuejasSugerencias.FindAsync(id); }
        ...
        public async Task<bool> Insertar(QuejasSugerenciasModel m)
        {
            try
            {
                ...
                new OracleParameter("p_satisfaccion", DBNull.Value /* Satisfaccion */)
                };
                await _context.Database.ExecuteSqlRawAsync(sql, p);
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar QuejasSugerenciasModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, QuejasSugerenciasModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar QuejasSugerenciasModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_quejas_sugerencias.delete_queja(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar QuejasSugerenciasModel: {ex.Message}"); return false; }
        }
    }
}
