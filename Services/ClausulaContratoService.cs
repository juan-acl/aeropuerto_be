...
namespace Aeropuerto.Backend.Services
{
    public class ClausulaContratoService : IClausulaContratoService
    {
        ...
        {
            try { return await _context.Contratos.ToListAsync(); }
        ...
        {
            try { return await _context.Contratos.FindAsync(id); }
        ...
        public async Task<bool> Insertar(Contratos m)
        {
            try
            {
                ...
                new OracleParameter("p_documento_contrato", OracleDbType.Blob) { Value = (object?)m.DocumentoContrato ?? DBNull.Value },
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar Contratos: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, Contratos m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar Contratos: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_contratos.delete_contrato(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar Contratos: {ex.Message}"); return false; }
        }
    }
}
