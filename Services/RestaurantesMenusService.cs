...
namespace Aeropuerto.Backend.Services
{
    public class RestaurantesMenusService : IRestaurantesMenusService
    {
        ...
        public RestaurantesMenusService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<RestaurantesMenusModel>> ListarTodo()
        {
            try { return await _replica.RestaurantesMenus.ToListAsync(); }
        ...
        {
            try { return await _replica.RestaurantesMenus.FindAsync(id); }
        ...
        public async Task<bool> Insertar(RestaurantesMenusModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar RestaurantesMenusModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, RestaurantesMenusModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar RestaurantesMenusModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_restaurantes_menus.delete_menu(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar RestaurantesMenusModel: {ex.Message}"); throw; }
        }
    }
}
