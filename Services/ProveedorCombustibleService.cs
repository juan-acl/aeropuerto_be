...
namespace Aeropuerto.Backend.Services
{
    public class ProveedorCombustibleService : IProveedorCombustibleService
    {
        ...
        public ProveedorCombustibleService(DBContext context) => _context = context;

        public async Task<List<ProveedoresCombustible>> ListarTodo()
        {
            try { return await _context.ProveedoresCombustible.ToListAsync(); }
        ...
        {
            try { return await _context.ProveedoresCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ProveedoresCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ProveedoresCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, ProveedoresCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ProveedoresCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_proveedores_combustible.delete_proveedor_combustible(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ProveedoresCombustible: {ex.Message}"); return false; }
        }
    }
}
