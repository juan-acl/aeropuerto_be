...
namespace Aeropuerto.Backend.Services
{
    public class RecepcionCombustibleService : IRecepcionCombustibleService
    {
        ...
        public RecepcionCombustibleService(DBContext context) => _context = context;

        public async Task<List<RecepcionesCombustible>> ListarTodo()
        {
            try { return await _context.RecepcionesCombustible.ToListAsync(); }
        ...
        {
            try { return await _context.RecepcionesCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(RecepcionesCombustible m)
        {
            try
            {
                ...
                new OracleParameter("p_certificado_calidad", OracleDbType.Blob) { Value = (object?)m.CertificadoCalidad ?? DBNull.Value },
                new OracleParameter("p_observaciones", (object?)m.Observaciones ?? DBNull.Value)
                };
                await _context.Database.ExecuteSqlRawAsync(sql, p);
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar RecepcionesCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, RecepcionesCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar RecepcionesCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_recepciones_combustible.delete_recepcion(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar RecepcionesCombustible: {ex.Message}"); return false; }
        }
    }
}
