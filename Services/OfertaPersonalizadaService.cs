...
namespace Aeropuerto.Backend.Services
{
    public class OfertaPersonalizadaService : IOfertaPersonalizadaService
    {
        ...
        {
            try { return await _context.OfertasPersonalizadas.ToListAsync(); }
        ...
        {
            try { return await _context.OfertasPersonalizadas.FindAsync(id); }
        ...
        public async Task<bool> Insertar(OfertasPersonalizadas m)
        {
            try
            {
                ...
                new OracleParameter("p_resultados", DBNull.Value /* Resultados */)
                };
                await _context.Database.ExecuteSqlRawAsync(sql, p);
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar OfertasPersonalizadas: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, OfertasPersonalizadas m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar OfertasPersonalizadas: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_ofertas_personalizadas.delete_oferta(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar OfertasPersonalizadas: {ex.Message}"); return false; }
        }
    }
}
