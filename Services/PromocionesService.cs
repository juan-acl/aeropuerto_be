...
namespace Aeropuerto.Backend.Services
{
    public class PromocionesService : IPromocionesService
    {
        ...
        {
            try { return await _context.Promociones.ToListAsync(); }
        ...
        {
            try { return await _context.Promociones.FindAsync(id); }
        ...
        public async Task<bool> Insertar(PromocionesModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar PromocionesModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, PromocionesModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar PromocionesModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_promociones.delete_promocion(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar PromocionesModel: {ex.Message}"); return false; }
        }
    }
}
