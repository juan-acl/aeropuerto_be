...
namespace Aeropuerto.Backend.Services
{
    public class SlotsAeropuertoService : ISlotsAeropuertoService
    {
        ...
        public SlotsAeropuertoService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<SlotsAeropuerto>> ListarTodo()
        {
            try { return await _replica.SlotsAeropuerto.ToListAsync(); }
        ...
        {
            try { return await _replica.SlotsAeropuerto.FindAsync(id); }
        ...
        public async Task<bool> Insertar(SlotsAeropuerto m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar SlotsAeropuerto: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, SlotsAeropuerto m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar SlotsAeropuerto: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_slots_aeropuerto.delete_slot(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar SlotsAeropuerto: {ex.Message}"); throw; }
        }
    }
}
