...
{
    public class CanjesPuntosService : ICanjesPuntosService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public CanjesPuntosService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<CanjesPuntos>> ListarTodo()
        {
            try { return await _replica.CanjesPuntos.ToListAsync(); }
        ...
        {
            try { return await _replica.CanjesPuntos.FindAsync(id); }
        ...
        public async Task<bool> Insertar(CanjesPuntos m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar CanjesPuntos: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, CanjesPuntos m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar CanjesPuntos: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_canjes_puntos.delete_canje(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar CanjesPuntos: {ex.Message}"); throw; }
        }
    }
}
