...
namespace Aeropuerto.Backend.Services
{
    public class TiendasVentasService : ITiendasVentasService
    {
        ...
        {
            try { return await _context.TiendasVentas.ToListAsync(); }
        ...
        {
            try { return await _context.TiendasVentas.FindAsync(id); }
        ...
        public async Task<bool> Insertar(TiendasVentasModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar TiendasVentasModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, TiendasVentasModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar TiendasVentasModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_tiendas_ventas.delete_venta(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar TiendasVentasModel: {ex.Message}"); return false; }
        }
    }
}
