...
{
    public class ReservasTransporteTerrestreService : IReservasTransporteTerrestreService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public ReservasTransporteTerrestreService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<ReservasTransporteTerrestre>> ListarTodo()
        {
            try { return await _replica.ReservasTransporte.ToListAsync(); }
        ...
        {
            try { return await _replica.ReservasTransporte.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ReservasTransporteTerrestre m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ReservasTransporteTerrestre: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, ReservasTransporteTerrestre m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ReservasTransporteTerrestre: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_reservas_transporte.delete_reserva(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ReservasTransporteTerrestre: {ex.Message}"); throw; }
        }
    }
}
