...
namespace Aeropuerto.Backend.Services
{
    public class ProhibicionesVueloService : IProhibicionesVueloService
    {
        ...
        public ProhibicionesVueloService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<ProhibicionesVueloModel>> ListarTodo()
        {
            try { return await _replica.ProhibicionesVuelo.ToListAsync(); }
        ...
        {
            try { return await _replica.ProhibicionesVuelo.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ProhibicionesVueloModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ProhibicionesVueloModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, ProhibicionesVueloModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ProhibicionesVueloModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_prohibiciones_vuelo.delete_prohibicion(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ProhibicionesVueloModel: {ex.Message}"); throw; }
        }
    }
}
