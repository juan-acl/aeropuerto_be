...
namespace Aeropuerto.Backend.Services
{
    public class CumplimientoNormativoService : ICumplimientoNormativoService
    {
        ...
        {
            try { return await _context.CumplimientoNormativo.ToListAsync(); }
        ...
        {
            try { return await _context.CumplimientoNormativo.FindAsync(id); }
        ...
        public async Task<bool> Insertar(CumplimientoNormativo m)
        {
            try
            {
                ...
                new OracleParameter("p_evidencia_cumplimiento", OracleDbType.Blob) { Value = (object?)m.EvidenciaCumplimiento ?? DBNull.Value },
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar CumplimientoNormativo: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, CumplimientoNormativo m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar CumplimientoNormativo: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_cumplimiento_normativo.delete_cumplimiento(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar CumplimientoNormativo: {ex.Message}"); return false; }
        }
    }
}
