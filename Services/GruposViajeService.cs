...
namespace Aeropuerto.Backend.Services
{
    public class GruposViajeService : IGruposViajeService
    {
        ...
        public GruposViajeService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<GruposViajeModel>> ListarTodo()
        {
            try { return await _replica.GruposViaje.ToListAsync(); }
        ...
        {
            try { return await _replica.GruposViaje.FindAsync(id); }
        ...
        public async Task<bool> Insertar(GruposViajeModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar GruposViajeModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, GruposViajeModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar GruposViajeModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_grupos_viaje.delete_grupo(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar GruposViajeModel: {ex.Message}"); throw; }
        }
    }
}
