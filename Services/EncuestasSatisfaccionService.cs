...
namespace Aeropuerto.Backend.Services
{
    public class EncuestasSatisfaccionService : IEncuestasSatisfaccionService
    {
        ...
        {
            try { return await _context.EncuestasSatisfaccion.ToListAsync(); }
        ...
        {
            try { return await _context.EncuestasSatisfaccion.FindAsync(id); }
        ...
        public async Task<bool> Insertar(EncuestasSatisfaccionModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar EncuestasSatisfaccionModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, EncuestasSatisfaccionModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar EncuestasSatisfaccionModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_encuestas_satisfaccion.delete_encuesta(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar EncuestasSatisfaccionModel: {ex.Message}"); return false; }
        }
    }
}
