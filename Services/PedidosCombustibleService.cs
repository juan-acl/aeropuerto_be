...
{
    public class PedidosCombustibleService : IPedidosCombustibleService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public PedidosCombustibleService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<PedidosCombustible>> ListarTodo()
        {
            try { return await _replica.PedidosCombustible.ToListAsync(); }
        ...
        {
            try { return await _replica.PedidosCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(PedidosCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar PedidosCombustible: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, PedidosCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar PedidosCombustible: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_pedidos_combustible.delete_pedido(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar PedidosCombustible: {ex.Message}"); throw; }
        }
    }
}
