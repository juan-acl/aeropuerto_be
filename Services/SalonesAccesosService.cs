...
namespace Aeropuerto.Backend.Services
{
    public class SalonesAccesosService : ISalonesAccesosService
    {
        ...
        {
            try { return await _context.SalonesAccesos.ToListAsync(); }
        ...
        {
            try { return await _context.SalonesAccesos.FindAsync(id); }
        ...
        public async Task<bool> Insertar(SalonesAccesosModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar SalonesAccesosModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, SalonesAccesosModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar SalonesAccesosModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_salones_accesos.delete_acceso(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar SalonesAccesosModel: {ex.Message}"); return false; }
        }
    }
}
