...
namespace Aeropuerto.Backend.Services
{
    public class ConcesionesComercialesService : IConcesionesComercialesService
    {
        ...
        public ConcesionesComercialesService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<ConcesionesComercialesModel>> ListarTodo()
        {
            try { return await _replica.ConcesionesComerciales.ToListAsync(); }
        ...
        {
            try { return await _replica.ConcesionesComerciales.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ConcesionesComercialesModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ConcesionesComercialesModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, ConcesionesComercialesModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ConcesionesComercialesModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_concesiones_comerciales.delete_concesion(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ConcesionesComercialesModel: {ex.Message}"); throw; }
        }
    }
}
