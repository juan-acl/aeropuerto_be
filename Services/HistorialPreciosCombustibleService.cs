...
namespace Aeropuerto.Backend.Services
{
    public class HistorialPreciosCombustibleService : IHistorialPreciosCombustibleService
    {
        ...
        public HistorialPreciosCombustibleService(DBContext context) => _context = context;

        public async Task<List<HistorialPreciosCombustible>> ListarTodo()
        {
            try { return await _context.HistorialPreciosCombustible.ToListAsync(); }
        ...
        {
            try { return await _context.HistorialPreciosCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(HistorialPreciosCombustible m)
        {
            try
            {
                ...
                new OracleParameter("p_precio_internacional_ref", DBNull.Value /* PrecioInternacionalRef */),
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar HistorialPreciosCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, HistorialPreciosCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar HistorialPreciosCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_historial_precios_combustible.delete_precio(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar HistorialPreciosCombustible: {ex.Message}"); return false; }
        }
    }
}
