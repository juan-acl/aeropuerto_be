...
{
    public class NotificacionesOaciService : INotificacionesOaciService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public NotificacionesOaciService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<NotificacionesOaci>> ListarTodo()
        {
            try { return await _replica.NotificacionesOaci.ToListAsync(); }
        ...
        {
            try { return await _replica.NotificacionesOaci.FindAsync(id); }
        ...
        public async Task<bool> Insertar(NotificacionesOaci m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar NotificacionesOaci: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, NotificacionesOaci m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar NotificacionesOaci: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_notificaciones_oaci.delete_notificacion(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar NotificacionesOaci: {ex.Message}"); throw; }
        }
    }
}
