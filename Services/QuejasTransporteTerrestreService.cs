...
{
    public class QuejasTransporteTerrestreService : IQuejasTransporteTerrestreService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public QuejasTransporteTerrestreService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<QuejasTransporteTerrestre>> ListarTodo()
        {
            try { return await _replica.QuejasTransporte.ToListAsync(); }
        ...
        {
            try { return await _replica.QuejasTransporte.FindAsync(id); }
        ...
        public async Task<bool> Insertar(QuejasTransporteTerrestre m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar QuejasTransporteTerrestre: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, QuejasTransporteTerrestre m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar QuejasTransporteTerrestre: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_quejas_transporte.delete_queja(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar QuejasTransporteTerrestre: {ex.Message}"); throw; }
        }
    }
}
