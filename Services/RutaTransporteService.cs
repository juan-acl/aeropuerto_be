...
{
    public class RutaTransporteService : IRutaTransporteService
    {
        ...
        {
            try { return await _context.RutasTransporte.ToListAsync(); }
        ...
        {
            try { return await _context.RutasTransporte.FindAsync(id); }
        ...
        public async Task<bool> Insertar(RutasTransporteTerrestre m)
        {
            try
            {
                ...
                new OracleParameter("p_duracion_estimada", DBNull.Value /* DuracionEstimada */),
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar RutasTransporteTerrestre: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, RutasTransporteTerrestre m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar RutasTransporteTerrestre: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_rutas_transporte.delete_ruta(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar RutasTransporteTerrestre: {ex.Message}"); return false; }
        }
    }
}
