...
namespace Aeropuerto.Backend.Services
{
    public class ReporteOaciService : IReporteOaciService
    {
        ...
        {
            try { return await _context.ReportesOaci.ToListAsync(); }
        ...
        {
            try { return await _context.ReportesOaci.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ReportesOaci m)
        {
            try
            {
                ...
                new OracleParameter("p_archivo_reporte", OracleDbType.Blob) { Value = (object?)m.ArchivoReporte ?? DBNull.Value },
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ReportesOaci: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, ReportesOaci m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ReportesOaci: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_reportes_oaci.delete_reporte(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ReportesOaci: {ex.Message}"); return false; }
        }
    }
}
