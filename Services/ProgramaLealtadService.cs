...
namespace Aeropuerto.Backend.Services
{
    public class ProgramaLealtadService : IProgramaLealtadService
    {
        ...
        {
            try { return await _context.ProgramaLealtad.ToListAsync(); }
        ...
        {
            try { return await _context.ProgramaLealtad.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ProgramaLealtadModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ProgramaLealtadModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, ProgramaLealtadModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ProgramaLealtadModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_programa_lealtad.delete_lealtad(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ProgramaLealtadModel: {ex.Message}"); return false; }
        }
    }
}
