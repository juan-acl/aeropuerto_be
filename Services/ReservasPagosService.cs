...
namespace Aeropuerto.Backend.Services
{
    public class ReservasPagosService : IReservasPagosService
    {
        ...
        {
            try { return await _context.ReservasPagos.ToListAsync(); }
        ...
        {
            try { return await _context.ReservasPagos.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ReservasPagosModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ReservasPagosModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, ReservasPagosModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ReservasPagosModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_reservas_pagos.delete_pago(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ReservasPagosModel: {ex.Message}"); return false; }
        }
    }
}
