...
namespace Aeropuerto.Backend.Services
{
    public class FacturasService : IFacturasService
    {
        ...
        public FacturasService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<FacturasModel>> ListarTodo()
        {
            try { return await _replica.Facturas.ToListAsync(); }
        ...
        {
            try { return await _replica.Facturas.FindAsync(id); }
        ...
        public async Task<bool> Insertar(FacturasModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar FacturasModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, FacturasModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar FacturasModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_facturas.delete_factura(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar FacturasModel: {ex.Message}"); throw; }
        }
    }
}
