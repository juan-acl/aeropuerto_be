...
namespace Aeropuerto.Backend.Services
{
    public class PasajeroPreferenciaService : IPasajeroPreferenciaService
    {
        ...
        {
            try { return await _context.PasajerosPreferencias.ToListAsync(); }
        ...
        {
            try { return await _context.PasajerosPreferencias.FindAsync(id); }
        ...
        public async Task<bool> Insertar(PasajeroPreferenciaModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar PasajeroPreferenciaModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, PasajeroPreferenciaModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar PasajeroPreferenciaModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_pasajeros_preferencias.delete_preferencia(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar PasajeroPreferenciaModel: {ex.Message}"); return false; }
        }
    }
}
