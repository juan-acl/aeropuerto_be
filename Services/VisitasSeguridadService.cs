...
namespace Aeropuerto.Backend.Services
{
    public class VisitasSeguridadService : IVisitasSeguridadService
    {
        ...
        public VisitasSeguridadService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<VisitasSeguridadModel>> ListarTodo()
        {
            try { return await _replica.VisitasSeguridad.ToListAsync(); }
        ...
        {
            try { return await _replica.VisitasSeguridad.FindAsync(id); }
        ...
        public async Task<bool> Insertar(VisitasSeguridadModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar VisitasSeguridadModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, VisitasSeguridadModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar VisitasSeguridadModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_visitas_seguridad.delete_visita(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar VisitasSeguridadModel: {ex.Message}"); throw; }
        }
    }
}
