...
{
    public class CertificacionAmbientalService : ICertificacionAmbientalService
    {
        private readonly DBContext _context;
        public CertificacionAmbientalService(DBContext context) => _context = context;

        public async Task<List<CertificacionesAmbientalesAeropuerto>> ListarTodo()
        {
            try { return await _context.CertificacionesAmbientales.ToListAsync(); }
        ...
        {
            try { return await _context.CertificacionesAmbientales.FindAsync(id); }
        ...
        public async Task<bool> Insertar(CertificacionesAmbientalesAeropuerto m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar CertificacionesAmbientalesAeropuerto: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, CertificacionesAmbientalesAeropuerto m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar CertificacionesAmbientalesAeropuerto: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_certificaciones_ambientales.delete_certificacion(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar CertificacionesAmbientalesAeropuerto: {ex.Message}"); return false; }
        }
    }
}
