...
{
    public class RecursosEmergenciaService : IRecursosEmergenciaService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public RecursosEmergenciaService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<RecursosEmergencia>> ListarTodo()
        {
            try { return await _replica.RecursosEmergencia.ToListAsync(); }
        ...
        {
            try { return await _replica.RecursosEmergencia.FindAsync(id); }
        ...
        public async Task<bool> Insertar(RecursosEmergencia m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar RecursosEmergencia: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, RecursosEmergencia m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar RecursosEmergencia: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_recursos_emergencia.delete_recurso(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar RecursosEmergencia: {ex.Message}"); throw; }
        }
    }
}
