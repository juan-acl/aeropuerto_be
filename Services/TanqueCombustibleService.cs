...
{
    public class TanqueCombustibleService : ITanqueCombustibleService
    {
        private readonly DBContext _context;
        public TanqueCombustibleService(DBContext context) => _context = context;

        public async Task<List<TanquesCombustible>> ListarTodo()
        {
            try { return await _context.TanquesCombustible.ToListAsync(); }
        ...
        {
            try { return await _context.TanquesCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(TanquesCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar TanquesCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, TanquesCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar TanquesCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_tanques_combustible.delete_tanque(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar TanquesCombustible: {ex.Message}"); return false; }
        }
    }
}
