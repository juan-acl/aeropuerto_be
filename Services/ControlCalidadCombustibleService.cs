...
namespace Aeropuerto.Backend.Services
{
    public class ControlCalidadCombustibleService : IControlCalidadCombustibleService
    {
        ...
        public ControlCalidadCombustibleService(DBContext context) => _context = context;

        public async Task<List<ControlCalidadCombustible>> ListarTodo()
        {
            try { return await _context.ControlCalidadCombustible.ToListAsync(); }
        ...
        {
            try { return await _context.ControlCalidadCombustible.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ControlCalidadCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ControlCalidadCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, ControlCalidadCombustible m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ControlCalidadCombustible: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_control_calidad_combustible.delete_muestra(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ControlCalidadCombustible: {ex.Message}"); return false; }
        }
    }
}
