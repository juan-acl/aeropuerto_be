...
{
    public class IncidentesSeguridadInformaticaService : IIncidentesSeguridadInformaticaService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public IncidentesSeguridadInformaticaService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<IncidentesSeguridadInformatica>> ListarTodo()
        {
            try { return await _replica.IncidentesSeguridadInformatica.ToListAsync(); }
        ...
        {
            try { return await _replica.IncidentesSeguridadInformatica.FindAsync(id); }
        ...
        public async Task<bool> Insertar(IncidentesSeguridadInformatica m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar IncidentesSeguridadInformatica: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, IncidentesSeguridadInformatica m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar IncidentesSeguridadInformatica: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_incidentes_seguridad.delete_incidente(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar IncidentesSeguridadInformatica: {ex.Message}"); throw; }
        }
    }
}
