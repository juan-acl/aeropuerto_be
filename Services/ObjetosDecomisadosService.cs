...
namespace Aeropuerto.Backend.Services
{
    public class ObjetosDecomisadosService : IObjetosDecomisadosService
    {
        ...
        public ObjetosDecomisadosService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<ObjetosDecomisadosModel>> ListarTodo()
        {
            try { return await _replica.ObjetosDecomisados.ToListAsync(); }
        ...
        {
            try { return await _replica.ObjetosDecomisados.FindAsync(id); }
        ...
        public async Task<bool> Insertar(ObjetosDecomisadosModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar ObjetosDecomisadosModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, ObjetosDecomisadosModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar ObjetosDecomisadosModel: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_objetos_decomisados.delete_decomiso(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar ObjetosDecomisadosModel: {ex.Message}"); throw; }
        }
    }
}
