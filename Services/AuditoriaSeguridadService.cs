...
namespace Aeropuerto.Backend.Services
{
    public class AuditoriaSeguridadService : IAuditoriaSeguridadService
    {
        ...
        {
            try { return await _context.AuditoriasSeguridad.ToListAsync(); }
        ...
        {
            try { return await _context.AuditoriasSeguridad.FindAsync(id); }
        ...
        public async Task<bool> Insertar(AuditoriasSeguridad m)
        {
            try
            {
                ...
                new OracleParameter("p_documento_auditoria", OracleDbType.Blob) { Value = (object?)m.DocumentoAuditoria ?? DBNull.Value },
                new OracleParameter("p_estado", (object?)m.Estado ?? DBNull.Value)
                };
                await _context.Database.ExecuteSqlRawAsync(sql, p);
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar AuditoriasSeguridad: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, AuditoriasSeguridad m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar AuditoriasSeguridad: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_auditorias_seguridad.delete_auditoria(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar AuditoriasSeguridad: {ex.Message}"); return false; }
        }
    }
}
