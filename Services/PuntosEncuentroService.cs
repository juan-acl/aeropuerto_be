...
{
    public class PuntosEncuentroService : IPuntosEncuentroService
    {
        private readonly DBContext _primary;
        private readonly ReplicaDBContext _replica;
        public PuntosEncuentroService(DBContext primary, ReplicaDBContext replica) { _primary = primary; _replica = replica; }

        public async Task<List<PuntosEncuentro>> ListarTodo()
        {
            try { return await _replica.PuntosEncuentro.ToListAsync(); }
        ...
        {
            try { return await _replica.PuntosEncuentro.FindAsync(id); }
        ...
        public async Task<bool> Insertar(PuntosEncuentro m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar PuntosEncuentro: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Actualizar(int id, PuntosEncuentro m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar PuntosEncuentro: {ex.Message}"); throw; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_puntos_encuentro.delete_punto(:p_id); END;";
                await _primary.Database.ExecuteSqlRawAsync(sql, new OracleParameter("p_id", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar PuntosEncuentro: {ex.Message}"); throw; }
        }
    }
}
