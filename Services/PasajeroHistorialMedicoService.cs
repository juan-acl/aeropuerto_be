...
namespace Aeropuerto.Backend.Services
{
    public class PasajeroHistorialMedicoService : IPasajeroHistorialMedicoService
    {
        ...
        {
            try { return await _context.PasajerosHistorialMedico.ToListAsync(); }
        ...
        {
            try { return await _context.PasajerosHistorialMedico.FindAsync(id); }
        ...
        public async Task<bool> Insertar(PasajeroHistorialMedicoModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar PasajeroHistorialMedicoModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, PasajeroHistorialMedicoModel m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar PasajeroHistorialMedicoModel: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_pasajeros_historial_medico.delete_historial(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar PasajeroHistorialMedicoModel: {ex.Message}"); return false; }
        }
    }
}
