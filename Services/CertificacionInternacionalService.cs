...
namespace Aeropuerto.Backend.Services
{
    public class CertificacionInternacionalService : ICertificacionInternacionalService
    {
        ...
        {
            try { return await _context.CertificacionesInternacionales.ToListAsync(); }
        ...
        {
            try { return await _context.CertificacionesInternacionales.FindAsync(id); }
        ...
        public async Task<bool> Insertar(CertificacionesInternacionales m)
        {
            try
            {
                ...
                new OracleParameter("p_documento_certificado", OracleDbType.Blob) { Value = (object?)m.DocumentoCertificado ?? DBNull.Value },
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Insertar CertificacionesInternacionales: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Actualizar(int id, CertificacionesInternacionales m)
        {
            ...
            catch (Exception ex) { Console.WriteLine($"ERROR Actualizar CertificacionesInternacionales: {ex.Message}"); return false; }
        }
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                string sql = "BEGIN pkg_certificaciones_internacionales.delete_certificacion(:); END;";
                await _context.Database.ExecuteSqlRawAsync(sql, new OracleParameter("", id));
                return true;
            }
            catch (Exception ex) { Console.WriteLine($"ERROR Eliminar CertificacionesInternacionales: {ex.Message}"); return false; }
        }
    }
}
