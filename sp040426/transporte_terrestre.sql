...
CREATE OR REPLACE PACKAGE BODY pkg_transporte_terrestre AS
    ...
    BEGIN
        INSERT INTO transporte_terrestre (
            ...
            telefono_contacto, tarifa_estimada, horario_operacion,
            activo
        ) VALUES (
            p_codigo_aeropuerto, p_tipo_transporte, p_empresa,
            p_telefono_contacto, p_tarifa_estimada, p_horario_operacion,
            NVL(p_activo,1)
        );
    EXCEPTION
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-34401, 'Error al insertar transporte terrestre: ' || SQLERRM);
    ...
    BEGIN
        ...
        DBMS_OUTPUT.PUT_LINE('Código aeropuerto: ' || r.codigo_aeropuerto);
    ...
    BEGIN
        ...
        IF SQL%ROWCOUNT = 0 THEN
            RAISE_APPLICATION_ERROR(-34402, 'No se encontró el transporte terrestre para actualizar.');
        END IF;
    ...
    BEGIN
        ...
        IF SQL%ROWCOUNT = 0 THEN
            RAISE_APPLICATION_ERROR(-34403, 'No se encontró el transporte terrestre para eliminar.');
        END IF;
