...
{
    [ApiController]
    [Route("api/tarifasvuelo")]
    public class TarifaVueloController : ControllerBase
    {
        private readonly ITarifaVueloService _service;
        public TarifaVueloController(ITarifaVueloService service) => _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Crear([FromBody] TarifaVueloModel modelo)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Actualizar(int id, [FromBody] TarifaVueloModel modelo)
        {
            try {
