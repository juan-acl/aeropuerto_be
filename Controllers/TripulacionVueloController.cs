...
{
    [ApiController]
    [Route("api/tripulacionvuelo")]
    public class TripulacionVueloController : ControllerBase
    {
        private readonly ITripulacionVueloService _service;
        public TripulacionVueloController(ITripulacionVueloService service) => _service = service;
        ...
        [HttpPost]
        public async Task<IActionResult> Crear([FromBody] TripulacionVueloModel modelo)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Actualizar(int id, [FromBody] TripulacionVueloModel modelo)
        {
            try {
