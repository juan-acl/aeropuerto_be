...
namespace Aeropuerto.Backend.Controllers
{
    ...
    public class OrdenCompraController : ControllerBase
    {
        ...
        public OrdenCompraController(IOrdenCompraService svc) { _svc = svc; }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] OrdenCompra m)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] OrdenCompra m)
        {
