...
namespace Aeropuerto.Backend.Controllers
{
    ...
    public class IngresoController : ControllerBase
    {
        ...
        public IngresoController(IIngresoService svc) { _svc = svc; }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Ingreso m)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Ingreso m)
        {
